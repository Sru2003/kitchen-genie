  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Kitchen Genie',style: TextStyle(color: myColor,fontSize: 30,fontFamily:'ShortBaby'),)),
      ),
      ...
      body: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(
              child: Text(
                'Welcome to Kitchen Genie!\n\nThis app helps you generate recipes based on the ingredients you have. Simply enter your ingredients above, and Kitchen Genie will provide you with delicious recipes to try out!',
